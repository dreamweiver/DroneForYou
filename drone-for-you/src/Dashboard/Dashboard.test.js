...
it("Dashboard renders correctly - return drone voluntarily", () => {
  ...
  wrapper.instance().setState({ ...wrapper.instance().state, allStations }); // initialise the stations with drones
...
//   const dronesStationCount =  3;
//   const {quads: drones} = allDrones;
//   const allStations  = UtilityHelper.divideDronesAcrossStations(drones, dronesStationCount)

//   const stationId =  0;
//   const selectedDrone = allStations[stationId][0];
//   console.info("selected Drone:", Array.isArray(allStations[stationId]));
//   wrapper.instance().setState({...wrapper.instance().state, {...allStations}); // initialise the stations with drones

//   wrapper.instance()._currentUser = {emailId : "xyz@gmail.com",
//       firstName: 'Manoj',
//       lastName:'Lakshman',
//       phoneNumber: '912',
//       isBanned: false};
